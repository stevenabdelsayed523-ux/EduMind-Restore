...
const FEATURES = [
  {
    icon: Brain,
    title: "AI Helper",
    desc: "Ask questions and get instant explanations during quizzes, flashcards, and study sessions.",
  },
  {
    icon: Zap,
    title: "Test Mode",
    desc: "Multiple-choice quizzes with scoring, streaks, and detailed performance breakdowns.",
  },
  {
    icon: FileText,
    title: "Smart Notes",
    desc: "Generate concise study notes and summaries from any topic in seconds.",
  },
  {
    icon: Bookmark,
    title: "Flashcards",
    desc: "Spaced-repetition decks that adapt to what you actually need to review.",
  },
  {
    icon: Calendar,
    title: "Study Plans",
    desc: "Personalised plans built around your exam dates, subjects, and goals.",
  },
  {
    icon: Trophy,
    title: "Progress Analytics",
    desc: "Mastery tracking, streaks, achievements, and subject-by-subject insights.",
  },
];
    ...
    <div className="min-h-screen bg-[#0a0d14] text-[#e8ecf8] font-sans relative overflow-x-hidden">
      ...
      <div className="relative z-10">
        <nav className="flex items-center justify-between px-6 md:px-10 py-5 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: "linear-gradient(135deg,#4a84f5 0%,#6366f1 100%)",
                boxShadow: "0 0 20px rgba(74,132,245,0.35)",
              }}
            >
              <Brain className="w-5 h-5 text-white" strokeWidth={2.2} />
            </div>
            <span className="font-serif text-2xl tracking-tight">
              Edu<em className="italic text-[#7ba8ff] not-italic" style={{ fontStyle: "italic" }}>Mind</em>
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              style={{
                ...
                boxShadow: "0 2px 12px rgba(74,132,245,.3)",
              }}
            >
              Get Started
            </button>
        ...
        <section className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
          ...
          <h1 className="font-serif text-5xl md:text-7xl leading-[1.05] tracking-tight mb-2">
            Study smarter,
          </h1>
          ...
          <p className="text-[#8892b0] text-base md:text-lg max-w-xl mx-auto leading-relaxed mb-10">
            EduMind combines quizzes, flashcards, an AI helper, and progress
            analytics into one beautiful study platform — for every subject,
            every year level.
          </p>
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap mb-14">
            <button
              ...
              style={{
                background: "linear-gradient(135deg,#4a84f5,#6366f1)",
                boxShadow: "0 4px 24px rgba(74,132,245,.35)",
              }}
            >
              Start studying free
